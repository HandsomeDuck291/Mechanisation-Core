...
import handsomeduck.starktech.mixin.OrePlacedFeaturesAccessor;
...
public class WorldGeneration {
    ...
    public static void init() {
        BiomeModification worldGen = BiomeModifications.create(new Identifier(StarkTech.MOD_ID, "world_features"));
