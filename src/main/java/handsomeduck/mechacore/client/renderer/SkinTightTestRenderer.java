package handsomeduck.mechacore.client.renderer;
...
import handsomeduck.mechacore.common.MechaCoreClient;
...
public class SkinTightTestRenderer implements ArmorRenderer {
    private static final Identifier SKIN_TIGHT_VARIANT_TEXTURE = new Identifier(MechaCore.MOD_ID, "textures/entity/armor/steve.png");
    ...
    public void render(MatrixStack matrices, VertexConsumerProvider vertexConsumers, ItemStack stack, LivingEntity entity, EquipmentSlot slot, int light, BipedEntityModel<LivingEntity> contextModel) {
        if (armorModel == null) {
            armorModel = new SkinTightTestModel<>(MinecraftClient.getInstance().getEntityModelLoader().getModelPart(MechaCoreClient.SKIN_TIGHT_MODEL_LAYER));
        }
